...
(function () {
  ...
  var JA = {
    ...
    'insp.p4': 'アーティストと「チーム」について——私にはわからない理由で、彼らは名乗らないことを選びました。とはいえ、日本と英国の両方の文化の繊細なニュアンスに深く通じ、鋭い目を持っていること——そして茶目っ気たっぷりの遊び心があること——は、なんとなく見て取れるはずです。「ユーティリティ」や「ロードマップ」の約束は、話半分に聞いておくのが賢明でしょう。日本にはこんなことわざがあります：千里の道も一歩から。それでは、ごきげんよう！',
    ...
    'wl.h1': 'ホワイトリストに登録',
    'wl.lead': 'あなたが人間であることを証明しよう——Mr Benimaruのスライドパズルを解いて応募フォームを解除。空いたマスの隣のタイルをクリックして動かします。絵を完成させればクリア。',
    'wl.newpuzzle': '新しいパズル',
    'wl.moves': '手数:',
    'wl.goal': '上の絵に合わせよう。',
    ...
    'wl.faq.a1': 'もうすぐ。™',
    'wl.faq.q2': 'チェーンは？',
    'wl.faq.a2': 'Ethereumメインネット。',
    'wl.faq.q3': '何体？',
    'wl.faq.a3': '71体の衣装、すべて唯一無二の1点もの。',
    'wl.faq.q4': '価格は？',
    'wl.faq.a4': 'ホワイトリストは無料。',
    'wl.faq.q5': 'どこで？',
    'wl.faq.a5': 'OpenSea。',
    'wl.faq.q6': 'ユーティリティ？ロードマップ？',
    'wl.faq.a6': '<a href="inspiration.html">塩ひとつまみ</a>をご参照ください。',
