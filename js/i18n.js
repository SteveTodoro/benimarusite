...
(function () {
  ...
  var JA = {
    ...
    'wl.h1': 'エアドロップに応募',
    'wl.lead': '下のスライドパズルを完成させて、Mr Benimaruのエアドロップの対象になろう。エアドロップは先着順で無料配布されます。',
    'wl.newpuzzle': '新パズル',
    'wl.moves': '手数:',
    'wl.goal': '上の絵に合わせよう。',
